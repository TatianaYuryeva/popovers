export class Popover {
  ...
  showPopover(message, element) {
    ...
    const { left, top } = element.getBoundingClientRect();
      this.popoverElement.style.left = (left + element.offsetWidth / 2) -  this.popoverElement.offsetWidth / 2 + 'px';
      this.popoverElement.style.top = top - this.popoverElement.offsetHeight - 10 + 'px';
  }
